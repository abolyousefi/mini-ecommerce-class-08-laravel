                            ...
                            <div class="card-body">
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="flex-fill">
                                        ...
                                        <div
                                            class="fs-22 fw-semibold mb-1 text-primary ">{{  $sellCount }}
                                        </div>
                            ...
                            <div class="card-body  ">
                                <div class="d-flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            class="fs-22 fw-semibold mb-1 text-success">{{ number_format($totalIncome) }}
                                            تومان
                                        </div>
                                        <div class="d-flex align-items-center  fs-11">
                                            <span class="text-default op-6">این ماه</span>
                            ...
                            <div class="card-body ">
                                <div class="d-flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            class="fs-22 fw-semibold mb-1 text-pink">{{ $userCount }}
                                        </div>
                                        <div class="d-flex align-items-center fs-11">
                                            <span class="text-default op-6">این ماه</span>
                                        </div>
